...
public class BOJ13460 {
	...
	public static void main(String[] args) throws IOException {
		...
		//로직
		int ans = bfs();
		System.out.println(ans == 0 || ans > 10 ? -1 : ans);
	}
	...
	private static int bfs() {
		...
		while (!q.isEmpty()) {
			...
			for (int dir = 0; dir < 4; dir++) {
				...
				Point nextRed = first.equals(cur.red) ? nextFirst : nextSecond;
				Point nextBlue = second.equals(cur.blue) ? nextSecond : nextFirst;

				if (v[nextRed.x][nextRed.y][nextBlue.x][nextBlue.y]) continue;
